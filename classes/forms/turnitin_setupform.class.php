...
class turnitin_setupform extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('text', 'plagiarism_turnitin_serviceaccount', get_string('turnitin_service_account', 'plagiarism_turnitin'));
        $mform->setType('plagiarism_turnitin_serviceaccount', PARAM_TEXT);
        $mform->addElement('static', 'plagiarism_turnitin_serviceaccount_desc', null, get_string('turnitin_service_account_desc', 'plagiarism_turnitin'));
        ...
        if ($DB->count_records('plagiarism_turnitin_users') > 0 && isset($config->plagiarism_turnitin_enablepseudo)) {
    ...
    public function save($data) {
        ...
        $properties = ["accountid", "secretkey", "apiurl", "enablediagnostic", "usegrademark", "enablepeermark",
            ...
            "pseudolastname", "lastnamegen", "pseudosalt", "pseudoemaildomain", "serviceaccount", "cron_submissions_limit", "cron_submissions_cleanup"];
